...
#' @references C. Lee and M. Wang. Smooth tensor estimation with unknown permutations. arXiv:2105.01783, 2021.
#' @examples
#'
...
#' @references J. Xu. Rates of convergence of spectral methods for graphon estimation. International Conference on Machine Learning, 2018. \cr C. Lee and M. Wang. Smooth tensor estimation with unknown permutations. arXiv:2105.01783, 2021.
#' @examples
#'
#' # Generate the noisy observation from smooth tensor and permutation
#' d = 20
